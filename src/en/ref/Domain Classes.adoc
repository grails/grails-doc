...
Refer to the link:../../guide/conf.html[configuration] section of more details on defining configuration options.

Refer to the user guide section on link:../../guide/GORM.html[GORM] for more information.
