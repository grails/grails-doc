...
The `validate` method validates a domain class based on its defined link:validation.html#constraints[Constraints]. The errors are stored in the link:../Domain%20Classes/errors.html[errors] property of the domain class instance.
