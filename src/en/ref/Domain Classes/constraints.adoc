...
Constraints are defined using the declarative constraints DSL as described in the link:validation.html[validation] section of the user guide. Once evaluated, validation can be applied through the use of the link:../Domain%20Classes/validate.html[validate] method:
