...
The `list` method on named queries supports the same attributes as the static `list` method added to domain classes (sort, order, ignoreCase, fetch etc...).  See the <<ref-domain-classes-list,list>> docs for details.
