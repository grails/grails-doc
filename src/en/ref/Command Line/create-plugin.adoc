...
Plugins are not just useful for plugin developers, but also as a way to modularize large Grails applications. Refer to the section on link:../../guide/plugins.html[Plugin Development] in the user guide for more information on developing plugins for Grails.
