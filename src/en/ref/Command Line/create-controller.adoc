...
If you want the command to default to a different package for controllers, provide a value for `grails.project.groupId` in the link:../../guide/conf.html[runtime configuration].
