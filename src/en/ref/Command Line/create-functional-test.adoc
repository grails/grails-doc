...
An functional test differs from a unit test in that the Grails environment is loaded for the test execution. Refer to the section on link:../../guide/testing.html[Unit Testing] of the user guide for information on unit vs. functional testing.
