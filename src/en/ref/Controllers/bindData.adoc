...
* `params` - A `Map` of source parameters, often the link:../Controllers/params.html[params] object when used in a controller
...
Refer to the section on link:../../guide/theWebLayer.html#dataBinding[data binding] in the user guide for more information.
