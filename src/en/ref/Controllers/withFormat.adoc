...
Renders different responses based on the incoming request `Accept` header, format parameter or URI extension. See link:../../guide/theWebLayer.html#contentNegotiation[Content Negotiation] for more information.
