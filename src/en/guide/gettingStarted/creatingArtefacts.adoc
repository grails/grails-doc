Grails ships with a few convenience targets such as <<ref-command-line-create-controller,create-controller>>, <<ref-command-line-create-domain-class,create-domain-class>> and so on that will create <<controllers,Controllers>> and different artefact types for you.
