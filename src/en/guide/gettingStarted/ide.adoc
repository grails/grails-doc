...
http://www.jetbrains.com/idea[IntelliJ IDEA] is an excellent IDE for Grails 5.0 development. It comes in 2 editions, the free community edition and the paid-for ultimate edition.
