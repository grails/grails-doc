...
WARNING: Grails' <<scaffolding,Scaffolding>> feature *does not* currently support many-to-many relationship and hence you must write the code to manage the relationship yourself
