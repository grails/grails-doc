...
NOTE: The link:GORM.html#ormdsl[ORM DSL] allows mapping unidirectional relationships using a foreign key association instead
...
If you need "eager" fetching you can use the link:GORM.html#ormdsl[ORM DSL] or specify eager fetching as part of a <<querying,query>>
