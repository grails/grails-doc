...
GORM provides a number of methods that work with HQL including <<ref-domain-classes-find,find>>, <<ref-domain-classes-findAll,findAll>> and <<ref-domain-classes-executeQuery,executeQuery>>. An example of a query can be seen below:
