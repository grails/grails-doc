An example of the <<ref-domain-classes-delete,delete>> method can be seen below:
...
If you really need to batch delete data you can use the <<ref-domain-classes-executeUpdate,executeUpdate>> method to do batch DML statements:
