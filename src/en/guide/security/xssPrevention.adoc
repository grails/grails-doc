...
There are more details about the XSS in <<ref-php-xss-28-cross-site-scripting29-prevention-cheat-sheet-xss-prevention-rules-OWASP - XSS prevention rules,OWASP - XSS prevention rules>> and <<ref-php-typesof-cross-site-scripting-OWASP - Types of Cross-Site Scripting,OWASP - Types of Cross-Site Scripting>>. Types of XSS are: <<ref-php-crosssite-scripting-xss-stored-xss-attacks-Stored XSS,Stored XSS>>, <<ref-php-crosssite-scripting-xss-reflected-xss-attacks-Reflected XSS,Reflected XSS>> and <<ref-php-dom-based-xss-DOM based XSS,DOM based XSS>>. <<ref-php-dom-based-xss-prevention-cheat-sheet-DOM based XSS prevention,DOM based XSS prevention>> is coming more important because of the popularity of Javascript client side templating and Single Page Apps. 
