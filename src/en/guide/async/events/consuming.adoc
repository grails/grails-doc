There are several ways to consume an event. As mentioned previously services and controllers implement the {apiDocs}grails/events/Events.html[Events] trait.
