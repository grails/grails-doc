...
NOTE: These events are triggered asynchronously, and so cannot cancel or manipulate the persistence operations. If you want to do that see the section on link:GORM.html#eventsAutoTimestamping[Events & Auto Timestamping] in the GORM docs
