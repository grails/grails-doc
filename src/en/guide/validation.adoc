...
Constraints in Grails are a way to declaratively specify validation rules. Most commonly they are applied to <<GORM,domain classes>>, however <<urlmappings,URL Mappings>> and <<commandObjects,Command Objects>> also support constraints.
