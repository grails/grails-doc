...
If you prefer to avoid the overhead of link:theWebLayer.html#dataBinding[data binding] and simply want to convert incoming parameters (typically Strings) into another more appropriate type the <<ref-controllers-params,params>> object has a number of convenience methods for each type:
