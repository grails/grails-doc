...
Internally the <<ref-controllers-redirect,redirect>> method uses the http://download.oracle.com/javaee/1.4/apijavax/servlet/http/HttpServletResponse.html[HttpServletResponse] object's `sendRedirect` method.
