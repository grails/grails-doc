...
GSPs live in the `grails-app/views` directory and are typically rendered automatically (by convention) or with the <<ref-controllers-render,render>> method such as:
