If you have collections of objects you often need to sort and filter them. Use the <<ref-tags-findAll,findAll>> and <<ref-tags-grep,grep>> tags for these tasks:
