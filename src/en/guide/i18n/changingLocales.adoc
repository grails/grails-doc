...
By default, Grails uses https://docs.spring.io/spring/docs/4.3.x/javadoc-api/org/springframework/web/servlet/i18n/SessionLocaleResolver.html[SessionLocaleResolver] as the `localeResolver` bean.
