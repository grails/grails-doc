Grails 3.1 ships with http://grails.github.io/grails-data-mapping/5.0.x/[GORM 5] which is a brand new release of GORM supporting the following technologies:
