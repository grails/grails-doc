...
The `respond` method will, using <<contentNegotiation,Content Negotiation>>, attempt to reply with the most appropriate response given the content type requested by the client (via the ACCEPT header or file extension).
